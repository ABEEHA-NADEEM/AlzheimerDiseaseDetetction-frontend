  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const [allUsers, pending] = await Promise.all([
        ...
        authAPI.getPendingDoctors(),  // ← fixed
      ])
    ...
    <div className="space-y-6 p-6">
        ...
        <Card>
          <div className="p-6 flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-semibold text-slate-900">{stats.activeDoctors}</p>
            </div>
        ...
        <Card>
          <div className="p-6 flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-semibold text-slate-900">{stats.totalScans}</p>
            </div>
        ...
        <Card>
          <div className="p-6 flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-semibold text-amber-600">{stats.pendingApprovals}</p>
            </div>
      ...
      <Card>
        <div className="p-6 border-b border-slate-200">
          <h2 className="text-lg font-semibold text-slate-900">Pending Doctor Approvals</h2>
        </div>
              ...
              >
                <div>
                  ...
                  <div className="mt-1 flex items-center gap-2">
                    <Badge variant="default">{doc.specialization || 'Not specified'}</Badge>
                    <span className="text-xs text-slate-400">
                      Applied: {doc.created_at ? new Date(doc.created_at).toLocaleDateString() : '—'}
                    </span>
                  </div>
                </div>
